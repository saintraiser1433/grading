...
interface GradeTypeFormProps {
  gradeType?: GradeType | null
  onClose?: () => void
}

export function GradeTypeForm({ gradeType, onClose }: GradeTypeFormProps) {
  ...
  return (
    <Card>
      <CardHeader>
        <CardTitle>Grade Type Information</CardTitle>
      </CardHeader>
      <CardContent>
